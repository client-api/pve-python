...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "PVEAuthCookie": APIKeyAuthSetting,
        "CSRFPreventionToken": APIKeyAuthSetting,
        "PVEApiToken": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = pve_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://localhost:8006/api2/json" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pve_client")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'PVEAuthCookie' in self.api_key:
            auth['PVEAuthCookie'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'PVEAuthCookie',
        ...
        if 'PVEApiToken' in self.api_key:
            auth['PVEApiToken'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
