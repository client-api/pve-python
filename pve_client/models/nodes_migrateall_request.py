...
class NodesMigrateallRequest(BaseModel):
    """
    NodesMigrateallRequest
    """ # noqa: E501

    maxworkers: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="Maximal number of parallel migration job. If not set, uses'max_workers' from datacenter.cfg. One of both must be set!")
    ...
    __properties: ClassVar[List[str]] = ["maxworkers", "target", "vms", "with-local-disks"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesMigrateallRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesMigrateallRequest from a dict"""
        if obj is None:
            return None
