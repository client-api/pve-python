...
class ClusterBulkActionShutdownRequest(BaseModel):
    """
    ClusterBulkActionShutdownRequest
    """ # noqa: E501

    force_stop: Optional[PveBoolean] = Field(default=None, description="Makes sure the Guest stops after the timeout.", alias="force-stop")
    ...
    __properties: ClassVar[List[str]] = ["force-stop", "maxworkers", "timeout", "vms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterBulkActionShutdownRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterBulkActionShutdownRequest from a dict"""
        if obj is None:
            return None
