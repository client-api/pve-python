...
class ClusterHaReadGetResourcesResponseData(BaseModel):
    ...
    max_relocate: Optional[StrictInt] = Field(default=None, description="Maximal number of service relocate tries when a service failes to start.")
    ...
    __properties: ClassVar[List[str]] = ["comment", "digest", "failback", "group", "max_relocate", "max_restart", "sid", "state", "type"]
