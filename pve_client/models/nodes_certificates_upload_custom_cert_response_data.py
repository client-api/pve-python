...
class NodesCertificatesUploadCustomCertResponseData(BaseModel):
    """
    ...
    san: Optional[List[StrictStr]] = Field(default=None, description="List of Certificate's SubjectAlternativeName entries.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesCertificatesUploadCustomCertResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesCertificatesUploadCustomCertResponseData from a dict"""
        if obj is None:
            return None
