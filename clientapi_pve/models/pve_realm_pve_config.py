...
class PveRealmPveConfig(BaseModel):
    """
    PveRealmPveConfig
    """ # noqa: E501
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pve']):
            raise ValueError("must be one of enum values ('pve')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveRealmPveConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveRealmPveConfig from a dict"""
        if obj is None:
            return None
