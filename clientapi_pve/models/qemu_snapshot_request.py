...
class QemuSnapshotRequest(BaseModel):
    """
    QemuSnapshotRequest
    """ # noqa: E501

    description: Optional[StrictStr] = Field(default=None, description="A textual description or comment.")

    snapname: Annotated[str, Field(strict=True, max_length=40)] = Field(description="The name of the snapshot.")

    vmstate: Optional[PveBoolean] = Field(default=None, description="Save the vmstate")

    __properties: ClassVar[List[str]] = ["description", "snapname", "vmstate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuSnapshotRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuSnapshotRequest from a dict"""
        if obj is None:
            return None
