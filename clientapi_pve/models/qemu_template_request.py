...
class QemuTemplateRequest(BaseModel):
    """
    QemuTemplateRequest
    """ # noqa: E501

    disk: Optional[PveQemuDiskEnum] = Field(default=None, description="If you want to convert only 1 disk to base image.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuTemplateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuTemplateRequest from a dict"""
        if obj is None:
            return None
