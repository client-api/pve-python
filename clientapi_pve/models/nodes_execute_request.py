...
class NodesExecuteRequest(BaseModel):
    """
    NodesExecuteRequest
    """ # noqa: E501

    commands: StrictStr = Field(description="JSON encoded array of commands, where each command is an object with the following properties:   args:      <object>       A set of parameter names and their values.    method:    (GET|POST|PUT|DELETE)       A method related to the API endpoint (GET, POST etc.).    path:      <string>       A relative path to an API endpoint on this node.  ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesExecuteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesExecuteRequest from a dict"""
        if obj is None:
            return None
