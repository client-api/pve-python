...
class NodesScanZfsscanResponseDataInner(BaseModel):
    """
    NodesScanZfsscanResponseDataInner
    """ # noqa: E501

    pool: StrictStr = Field(description="ZFS pool name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesScanZfsscanResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesScanZfsscanResponseDataInner from a dict"""
        if obj is None:
            return None
