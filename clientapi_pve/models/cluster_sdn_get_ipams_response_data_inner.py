...
class ClusterSdnGetIpamsResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ipam", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnGetIpamsResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnGetIpamsResponseDataInner from a dict"""
        if obj is None:
            return None
