...
class QemuAgentRequest(BaseModel):
    """
    QemuAgentRequest
    """ # noqa: E501

    command: PveQemuCommandEnum = Field(description="The QGA command.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuAgentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuAgentRequest from a dict"""
        if obj is None:
            return None
