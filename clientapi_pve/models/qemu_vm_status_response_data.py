...
class QemuVmStatusResponseData(BaseModel):
    """
    QemuVmStatusResponseData
    """ # noqa: E501

    agent: Optional[PveBoolean] = Field(default=None, description="QEMU Guest Agent is enabled in config.")
    ...
    spice: Optional[PveBoolean] = Field(default=None, description="QEMU VGA configuration supports spice.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuVmStatusResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuVmStatusResponseData from a dict"""
        if obj is None:
            return None
