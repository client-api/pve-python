...
class NodesScanLvmscanResponseDataInner(BaseModel):
    """
    NodesScanLvmscanResponseDataInner
    """ # noqa: E501

    vg: StrictStr = Field(description="The LVM logical volume group name.")

    __properties: ClassVar[List[str]] = ["vg"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesScanLvmscanResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesScanLvmscanResponseDataInner from a dict"""
        if obj is None:
            return None
