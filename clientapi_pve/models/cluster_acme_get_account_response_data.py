...
class ClusterAcmeGetAccountResponseData(BaseModel):
    """
    ...
    directory: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="URL of ACME CA directory endpoint.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterAcmeGetAccountResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterAcmeGetAccountResponseData from a dict"""
        if obj is None:
            return None
