...
class LxcIpResponseDataInnerIpAddressesInner(BaseModel):
    """
    LxcIpResponseDataInnerIpAddressesInner
    """ # noqa: E501

    ip_address: Optional[StrictStr] = Field(default=None, description="IP-Address", alias="ip-address")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LxcIpResponseDataInnerIpAddressesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LxcIpResponseDataInnerIpAddressesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ip-address": obj.get("ip-address"),
            "ip-address-type": obj.get("ip-address-type"),
