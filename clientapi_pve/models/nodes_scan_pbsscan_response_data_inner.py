...
class NodesScanPbsscanResponseDataInner(BaseModel):
    """
    NodesScanPbsscanResponseDataInner
    """ # noqa: E501

    comment: Optional[StrictStr] = Field(default=None, description="Comment from server.")

    store: StrictStr = Field(description="The datastore name.")

    __properties: ClassVar[List[str]] = ["comment", "store"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesScanPbsscanResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesScanPbsscanResponseDataInner from a dict"""
        if obj is None:
            return None
