...
class PveSdnZoneQinqConfig(BaseModel):
    """
    ...
    tag: Annotated[int, Field(strict=True, ge=0)] = Field(description="Service-VLAN Tag (outer VLAN)")
    ...
    __properties: ClassVar[List[str]] = ["lock-token", "secondary-controllers", "zone", "nodes", "tag", "bridge", "bridge-disable-mac-learning", "mtu", "vlan-protocol", "dns", "reversedns", "dnszone", "ipam", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['qinq']):
            raise ValueError("must be one of enum values ('qinq')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveSdnZoneQinqConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveSdnZoneQinqConfig from a dict"""
        if obj is None:
            return None
