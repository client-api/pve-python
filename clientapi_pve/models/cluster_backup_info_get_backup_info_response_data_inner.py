...
class ClusterBackupInfoGetBackupInfoResponseDataInner(BaseModel):
    """
    ClusterBackupInfoGetBackupInfoResponseDataInner
    """ # noqa: E501

    subdir: StrictStr = Field(description="API sub-directory endpoint")

    __properties: ClassVar[List[str]] = ["subdir"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterBackupInfoGetBackupInfoResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterBackupInfoGetBackupInfoResponseDataInner from a dict"""
        if obj is None:
            return None
