...
class ClusterFirewallRefsResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "name", "ref", "scope", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterFirewallRefsResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterFirewallRefsResponseDataInner from a dict"""
        if obj is None:
            return None
