...
class ClusterSdnListRouteMapsResponse(BaseModel):
    """
    ClusterSdnListRouteMapsResponse
    """ # noqa: E501

    data: List[ClusterSdnListRouteMapsResponseDataInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnListRouteMapsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnListRouteMapsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [ClusterSdnListRouteMapsResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
