...
class QemuTermproxyRequest(BaseModel):
    """
    QemuTermproxyRequest
    """ # noqa: E501

    serial: Optional[PveQemuSerialEnum] = Field(default=None, description="opens a serial terminal (defaults to display)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuTermproxyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuTermproxyRequest from a dict"""
        if obj is None:
            return None
