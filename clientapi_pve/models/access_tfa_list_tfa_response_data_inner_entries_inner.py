...
class AccessTfaListTfaResponseDataInnerEntriesInner(BaseModel):
    """
    ...
    enable: Optional[PveBoolean] = Field(default=None, description="Whether this TFA entry is currently enabled.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessTfaListTfaResponseDataInnerEntriesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessTfaListTfaResponseDataInnerEntriesInner from a dict"""
        if obj is None:
            return None
