...
class ClusterSdnUpdateDnsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete", "digest", "fingerprint", "key", "lock-token", "reversemaskv6", "ttl", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnUpdateDnsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnUpdateDnsRequest from a dict"""
        if obj is None:
            return None
