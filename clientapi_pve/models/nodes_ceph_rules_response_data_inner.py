...
class NodesCephRulesResponseDataInner(BaseModel):
    """
    NodesCephRulesResponseDataInner
    """ # noqa: E501

    name: StrictStr = Field(description="Name of the CRUSH rule.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesCephRulesResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesCephRulesResponseDataInner from a dict"""
        if obj is None:
            return None
