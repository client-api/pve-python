...
class LxcVmShutdownRequest(BaseModel):
    """
    LxcVmShutdownRequest
    """ # noqa: E501

    force_stop: Optional[PveBoolean] = Field(default=None, description="Make sure the Container stops.", alias="forceStop")

    timeout: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=60, description="Wait maximal timeout seconds.")

    __properties: ClassVar[List[str]] = ["forceStop", "timeout"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LxcVmShutdownRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LxcVmShutdownRequest from a dict"""
        if obj is None:
            return None
