...
class QemuSnapshotListResponseDataInner(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Snapshot identifier. Value 'current' identifies the current VM.")
    ...
    __properties: ClassVar[List[str]] = ["description", "name", "parent", "snaptime", "vmstate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuSnapshotListResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuSnapshotListResponseDataInner from a dict"""
        if obj is None:
            return None
