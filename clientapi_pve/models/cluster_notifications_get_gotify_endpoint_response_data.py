...
class ClusterNotificationsGetGotifyEndpointResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "digest", "disable", "name", "server"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterNotificationsGetGotifyEndpointResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterNotificationsGetGotifyEndpointResponseData from a dict"""
        if obj is None:
            return None
