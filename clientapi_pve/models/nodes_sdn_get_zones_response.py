...
class NodesSdnGetZonesResponse(BaseModel):
    ...
    data: List[NodesSdnGetZonesResponseDataInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [NodesSdnGetZonesResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
