...
class ClusterNotificationsGetMatchersResponse(BaseModel):
    """
    ClusterNotificationsGetMatchersResponse
    """ # noqa: E501

    data: List[ClusterNotificationsGetMatchersResponseDataInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterNotificationsGetMatchersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterNotificationsGetMatchersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [ClusterNotificationsGetMatchersResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
