...
class ClusterGetStatusResponseDataInner(BaseModel):
    """
    ...
    local: Optional[PveBoolean] = Field(default=None, description="[node] Indicates if this is the responding node.")
    ...
    quorate: Optional[PveBoolean] = Field(default=None, description="[cluster] Indicates if there is a majority of nodes online to make decisions")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterGetStatusResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterGetStatusResponseDataInner from a dict"""
        if obj is None:
            return None
