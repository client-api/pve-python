...
class ClusterSdnCreateEntriesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["action", "ge", "le", "lock-token", "prefix", "seq"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnCreateEntriesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnCreateEntriesRequest from a dict"""
        if obj is None:
            return None
