...
class ClusterSdnListRouteMapsResponseDataInner(BaseModel):
    """
    ClusterSdnListRouteMapsResponseDataInner
    """ # noqa: E501

    id: StrictStr = Field(description="The SDN route map identifier")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnListRouteMapsResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnListRouteMapsResponseDataInner from a dict"""
        if obj is None:
            return None
