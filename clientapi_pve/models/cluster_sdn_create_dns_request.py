...
class ClusterSdnCreateDnsRequest(BaseModel):
    """
    ClusterSdnCreateDnsRequest
    """ # noqa: E501

    dns: Annotated[str, Field(min_length=2, strict=True)] = Field(description="The SDN dns object identifier.")
    ...
    __properties: ClassVar[List[str]] = ["dns", "fingerprint", "key", "lock-token", "reversemaskv6", "reversev6mask", "ttl", "type", "url"]


    @field_validator('dns')
    def dns_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnCreateDnsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnCreateDnsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "reversemaskv6": obj.get("reversemaskv6"),
            "reversev6mask": obj.get("reversev6mask"),
            "ttl": obj.get("ttl"),
            "type": obj.get("type"),
            "url": obj.get("url")
        })
