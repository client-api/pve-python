...
class NodesDisksGetListResponseDataInner(BaseModel):
    ...
    devpath: StrictStr = Field(description="The device path")
    ...
    __properties: ClassVar[List[str]] = ["devpath", "gpt", "health", "model", "mounted", "osdid", "osdid-list", "parent", "serial", "size", "used", "vendor", "wwn"]
