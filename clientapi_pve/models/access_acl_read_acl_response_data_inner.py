...
class AccessAclReadAclResponseDataInner(BaseModel):
    """
    ...
    propagate: Optional[PveBoolean] = Field(default=None, description="Allow to propagate (inherit) permissions.")
    ...
    __properties: ClassVar[List[str]] = ["path", "propagate", "roleid", "type", "ugid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessAclReadAclResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessAclReadAclResponseDataInner from a dict"""
        if obj is None:
            return None
