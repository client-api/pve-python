...
class NodesStatusNodeCmdRequest(BaseModel):
    """
    NodesStatusNodeCmdRequest
    """ # noqa: E501

    command: PveNodesStatusCommandEnum = Field(description="Specify the command.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesStatusNodeCmdRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesStatusNodeCmdRequest from a dict"""
        if obj is None:
            return None
