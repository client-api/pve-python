...
class AccessTfaAddTfaEntryResponseData(BaseModel):
    """
    ...
    recovery: Optional[List[StrictStr]] = Field(default=None, description="When adding recovery codes, this contains the list of codes to be displayed to the user")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessTfaAddTfaEntryResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessTfaAddTfaEntryResponseData from a dict"""
        if obj is None:
            return None
