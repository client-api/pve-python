...
class PveSdnZoneFaucetConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["lock-token", "secondary-controllers", "zone", "nodes", "dp-id", "controller", "dns", "reversedns", "dnszone", "ipam", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['faucet']):
            raise ValueError("must be one of enum values ('faucet')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveSdnZoneFaucetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveSdnZoneFaucetConfig from a dict"""
        if obj is None:
            return None
