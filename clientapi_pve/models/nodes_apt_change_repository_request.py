...
class NodesAptChangeRepositoryRequest(BaseModel):
    """
    NodesAptChangeRepositoryRequest
    """ # noqa: E501

    digest: Optional[Annotated[str, Field(strict=True, max_length=80)]] = Field(default=None, description="Digest to detect modifications.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesAptChangeRepositoryRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesAptChangeRepositoryRequest from a dict"""
        if obj is None:
            return None
