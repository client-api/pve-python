...
class NodesScanCifsscanResponseDataInner(BaseModel):
    """
    NodesScanCifsscanResponseDataInner
    """ # noqa: E501

    description: StrictStr = Field(description="Descriptive text from server.")

    share: StrictStr = Field(description="The cifs share name.")

    __properties: ClassVar[List[str]] = ["description", "share"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesScanCifsscanResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesScanCifsscanResponseDataInner from a dict"""
        if obj is None:
            return None
