...
class NodesScanNfsscanResponseDataInner(BaseModel):
    """
    NodesScanNfsscanResponseDataInner
    """ # noqa: E501

    options: StrictStr = Field(description="NFS export options.")

    path: StrictStr = Field(description="The exported path.")

    __properties: ClassVar[List[str]] = ["options", "path"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesScanNfsscanResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesScanNfsscanResponseDataInner from a dict"""
        if obj is None:
            return None
