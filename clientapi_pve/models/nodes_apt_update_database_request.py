...
class NodesAptUpdateDatabaseRequest(BaseModel):
    """
    NodesAptUpdateDatabaseRequest
    """ # noqa: E501

    notify: Optional[PveBoolean] = Field(default=None, description="Send notification about new packages.")

    quiet: Optional[PveBoolean] = Field(default=None, description="Only produces output suitable for logging, omitting progress indicators.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesAptUpdateDatabaseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesAptUpdateDatabaseRequest from a dict"""
        if obj is None:
            return None
