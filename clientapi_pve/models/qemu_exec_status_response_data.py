...
class QemuExecStatusResponseData(BaseModel):
    """
    QemuExecStatusResponseData
    """ # noqa: E501

    err_data: Optional[StrictStr] = Field(default=None, description="stderr of the process", alias="err-data")
    ...
    out_data: Optional[StrictStr] = Field(default=None, description="stdout of the process", alias="out-data")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuExecStatusResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuExecStatusResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "err-data": obj.get("err-data"),
            "err-truncated": obj.get("err-truncated"),
            "exitcode": obj.get("exitcode"),
            "exited": obj.get("exited"),
            "out-data": obj.get("out-data"),
            "out-truncated": obj.get("out-truncated"),
