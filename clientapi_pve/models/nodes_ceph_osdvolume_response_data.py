...
class NodesCephOsdvolumeResponseData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["creation_time", "lv_name", "lv_path", "lv_size", "lv_uuid", "vg_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesCephOsdvolumeResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesCephOsdvolumeResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "lv_name": obj.get("lv_name"),
            "lv_path": obj.get("lv_path"),
            "lv_size": obj.get("lv_size"),
            "lv_uuid": obj.get("lv_uuid"),
            "vg_name": obj.get("vg_name")
        })
        return _obj
