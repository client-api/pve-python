...
class NodesDisksCreateLvmthinRequest(BaseModel):
    """
    NodesDisksCreateLvmthinRequest
    """ # noqa: E501

    add_storage: Optional[PveBoolean] = Field(default=None, description="Configure storage using the thinpool.")
    ...
    __properties: ClassVar[List[str]] = ["add_storage", "device", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesDisksCreateLvmthinRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesDisksCreateLvmthinRequest from a dict"""
        if obj is None:
            return None
