...
class ClusterSdnSetOptionsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete", "digest", "enable", "log_level_forward", "policy_forward"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnSetOptionsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnSetOptionsRequest from a dict"""
        if obj is None:
            return None
