...
class NodesCapabilitiesCapabilitiesResponseData(BaseModel):
    """
    NodesCapabilitiesCapabilitiesResponseData
    """ # noqa: E501

    has_dbus_vmstate: PveBoolean = Field(description="Whether the host supports live-migrating additional VM state via the dbus-vmstate helper.", alias="has-dbus-vmstate")

    __properties: ClassVar[List[str]] = ["has-dbus-vmstate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesCapabilitiesCapabilitiesResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesCapabilitiesCapabilitiesResponseData from a dict"""
        if obj is None:
            return None
