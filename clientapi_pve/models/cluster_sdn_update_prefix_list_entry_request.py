...
class ClusterSdnUpdatePrefixListEntryRequest(BaseModel):
    """
    ...
    delete: Optional[List[PveClusterSdnInlineEnum2]] = None
    ...
    __properties: ClassVar[List[str]] = ["action", "delete", "digest", "ge", "le", "lock-token", "prefix", "seq"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnUpdatePrefixListEntryRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnUpdatePrefixListEntryRequest from a dict"""
        if obj is None:
            return None
