...
class PveStorageIscsidirectConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["authsupported", "storage", "portal", "target", "nodes", "disable", "content", "bwlimit", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['iscsidirect']):
            raise ValueError("must be one of enum values ('iscsidirect')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveStorageIscsidirectConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveStorageIscsidirectConfig from a dict"""
        if obj is None:
            return None
