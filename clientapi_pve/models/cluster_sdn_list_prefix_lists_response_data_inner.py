...
class ClusterSdnListPrefixListsResponseDataInner(BaseModel):
    """
    ClusterSdnListPrefixListsResponseDataInner
    """ # noqa: E501

    id: StrictStr = Field(description="URL slug of the child resource (inferred from PVE HATEOAS link).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnListPrefixListsResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnListPrefixListsResponseDataInner from a dict"""
        if obj is None:
            return None
