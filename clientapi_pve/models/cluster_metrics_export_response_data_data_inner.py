...
class ClusterMetricsExportResponseDataDataInner(BaseModel):
    """
    ClusterMetricsExportResponseDataDataInner
    """ # noqa: E501

    id: StrictStr = Field(description="Unique identifier for this metric object, for instance 'node/<nodename>' or 'qemu/<vmid>'.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterMetricsExportResponseDataDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterMetricsExportResponseDataDataInner from a dict"""
        if obj is None:
            return None
