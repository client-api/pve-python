...
class ClusterSdnUpdateIpamsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["delete", "digest", "fingerprint", "lock-token", "section", "token", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterSdnUpdateIpamsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterSdnUpdateIpamsRequest from a dict"""
        if obj is None:
            return None
