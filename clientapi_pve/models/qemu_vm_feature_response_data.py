...
class QemuVmFeatureResponseData(BaseModel):
    """
    QemuVmFeatureResponseData
    """ # noqa: E501

    has_feature: PveBoolean = Field(alias="hasFeature")

    nodes: List[StrictStr]

    __properties: ClassVar[List[str]] = ["hasFeature", "nodes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuVmFeatureResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuVmFeatureResponseData from a dict"""
        if obj is None:
            return None
