...
class NodesHardwareMdevscanResponseDataInner(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="A human readable name for the type.")

    type: StrictStr = Field(description="The name of the mdev type.")

    __properties: ClassVar[List[str]] = ["available", "description", "name", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesHardwareMdevscanResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesHardwareMdevscanResponseDataInner from a dict"""
        if obj is None:
            return None
