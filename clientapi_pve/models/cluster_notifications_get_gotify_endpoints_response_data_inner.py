...
class ClusterNotificationsGetGotifyEndpointsResponseDataInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "disable", "name", "origin", "server"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClusterNotificationsGetGotifyEndpointsResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClusterNotificationsGetGotifyEndpointsResponseDataInner from a dict"""
        if obj is None:
            return None
