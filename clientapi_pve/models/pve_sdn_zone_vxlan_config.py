...
class PveSdnZoneVxlanConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["lock-token", "secondary-controllers", "zone", "nodes", "peers", "vxlan-port", "mtu", "dns", "reversedns", "dnszone", "ipam", "fabric", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['vxlan']):
            raise ValueError("must be one of enum values ('vxlan')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveSdnZoneVxlanConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveSdnZoneVxlanConfig from a dict"""
        if obj is None:
            return None
