...
class PveSdnControllerEvpnConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bgp-mode", "controller", "lock-token", "nodes", "peer-group-name", "route-map-in", "route-map-out", "asn", "peers", "fabric", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveSdnControllerEvpnConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveSdnControllerEvpnConfig from a dict"""
        if obj is None:
            return None
