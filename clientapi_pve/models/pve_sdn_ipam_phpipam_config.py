...
class PveSdnIpamPhpipamConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ipam", "lock-token", "url", "token", "section", "fingerprint", "type"]
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['phpipam']):
            raise ValueError("must be one of enum values ('phpipam')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PveSdnIpamPhpipamConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PveSdnIpamPhpipamConfig from a dict"""
        if obj is None:
            return None
