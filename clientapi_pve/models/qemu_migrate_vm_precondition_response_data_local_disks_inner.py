...
class QemuMigrateVmPreconditionResponseDataLocalDisksInner(BaseModel):
    """
    QemuMigrateVmPreconditionResponseDataLocalDisksInner
    """ # noqa: E501

    cdrom: PveBoolean = Field(description="True if the disk is a cdrom.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QemuMigrateVmPreconditionResponseDataLocalDisksInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QemuMigrateVmPreconditionResponseDataLocalDisksInner from a dict"""
        if obj is None:
            return None
