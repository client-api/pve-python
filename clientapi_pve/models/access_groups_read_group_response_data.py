...
class AccessGroupsReadGroupResponseData(BaseModel):
    """
    ...
    members: List[Annotated[str, Field(strict=True, max_length=64)]]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessGroupsReadGroupResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessGroupsReadGroupResponseData from a dict"""
        if obj is None:
            return None
